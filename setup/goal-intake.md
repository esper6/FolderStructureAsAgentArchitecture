...
Answer the questions below. Be as brief or detailed as you like — Stage 1 will
structure your answers into a clear goal document and flag anything unclear.
You can leave sections blank; Stage 1 will make reasonable assumptions and note them.

---

## What do you want to achieve?
<!-- What is the end result you're working toward? What does "done" look like?
...
<!-- Describe the thing you want to produce each time the pipeline runs.
...
<!-- This helps calibrate how the generated workspace is written.
     Pick the closest option or describe in your own words:
     - Not at all — I use Word, Excel, email. Command line is not for me.
     - Somewhat — I can follow technical instructions if they're clear.
     - Comfortable — I use tools like VS Code, Git, or similar regularly.
